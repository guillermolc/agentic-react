...
interface ChatInterfaceProps {
  agent: AgentConfig;
  messages: Message[];
  onSend: (content: string, selectedSpaces: string[], provider: string, model: string, workiqItems?: WorkIQResult[], kdbRefs?: string[]) => Promise<void>;
    ...
    <div className="flex flex-col h-[calc(100vh-13rem)]">
      ...
      <div className="border-t border-border pt-4">
        <div className="flex gap-3 items-stretch">
          ...
          <KDBSelector
            onSelectionChange={setSelectedKdbIds}
            disabled={disabled || isStreaming}
          />
          <AtlassianSelector
            disabled={disabled || isStreaming}
